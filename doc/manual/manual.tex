...
``apache2'' for apache version \Entity{gt} 2.x.y, ``apache'' to enable apache
...
3.1.1. Configuring Apache 2.x for modxslt}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:164}}\endNode{}\Node%
{\def\Element%
...
3.1.2. modxslt Configuration parameters}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:191}}\endNode{}\Node%
{\def\Element%
...
3.1.3. Apache 2.x.x, modxslt and PHP4}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:225}}\endNode{}\Node%
{\def\Element%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:498}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:499}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:538}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}a http URL \Node%
{\def\Element%
{0:539}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
mod-\/xslt will run with the same privileges as your web server.\endPar{}\endNode{}\Node%
{\def\Element%
{0:637}}\Par%
{\def\FirstLineStartIndent%
{0\p@}\def\FirstLineStartIndentFactor%
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}Let's say you are using apache and that a browser issues
