...
{center}\def\fFamName{Arial}\def\fWeight%
{bold}\def\fSize%
{12\p@}}Date: 2013/04/25 23:57:16\endPar{}\endNode{}\Seq%
{}\Node%
{\def\Element%
...
transformation of xslt stylesheet.\endPar{}\endNode{}\endDisplayGroup{}\endDisplayGroup{}\endNode{}\endSeq{}\endSeq{}\endSeq{}\endSeq{}\endSeq{}\endSeq{}\Node%
{\def\Element%
{0:1}}\endNode{}\Node%
{\def\Element%
{0:8}}\DisplayGroup%
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}mod-\/xslt2 is a server side module able to transform ``xml'' documents in
``html'' (or any other format). mod-\/xsl2 can bew used with most apache
version, including the now obsolete 1.3 and most 2.X branches.\endPar{}\endNode{}\Node%
{\def\Element%
{0:11}}\Par%
{\def\FirstLineStartIndent%
{0\p@}\def\FirstLineStartIndentFactor%
...
{}ability to transform dynamically generated xml (ability to parse the output of php or perl scripts).\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:15}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{}ability to use ``xslt'' stylesheets indicated via the \Entity{lt}?xml-\/stylesheet
processing instruction.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:17}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{}ability to send back the xml file unparsed to the browser.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:19}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{}ability to fetch xslt or DTDs from scripts rather than from static files.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:21}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
headers, of the get parameters or the web server environment.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:23}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
output.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\endDisplayGroup{}\endNode{}
...
documentation included in the original package.\endPar{}\endNode{}\endSeq{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:26}}\DisplayGroup%
{\def\StartIndent%
{48\p@}\def\StartIndentFactor%
...
~~\$~mkdir~build
~~\$~cd~build
~~\$~../configure~-\/-\/with-\/sapi=apache2\endPar{}\endNode{}
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}If you do not specify anything ``-\/-\/with-\/sapi'' configure will try to
detect the web server by itself.\endPar{}\endNode{}\Node%
{\def\Element%
{0:61}}\Par%
{\def\FirstLineStartIndent%
{0\p@}\def\FirstLineStartIndentFactor%
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}Configure will also try to autodetect most of the needed parameters and will
warn you about incompatibilities it \Node%
{\def\Element%
{0:62}}\Seq%
{\def\fPosture%
{italic}}will\endSeq{}\endNode{}
...
those patches.\endPar{}\endNode{}\Node%
{\def\Element%
{0:63}}\Par%
{\def\FirstLineStartIndent%
{0\p@}\def\FirstLineStartIndentFactor%
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}After successful configure completion, you should run:
\Node%
{\def\Element%
{0:64}}\Par%
{\def\fSize%
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}Read ``./configure -\/-\/help'' for an authoritative list of parameters. In these
sections we will cover only the most important ones.\endPar{}\endNode{}\Node%
{\def\Element%
{0:69}}\DisplayGroup%
{\def\StartIndent%
{48\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{\def\fPosture%
{italic}}-\/-\/bindir=BINDIR\endSeq{}\endNode{} BINDIR is the directory where mod-\/xslt
binaries (modxslt-\/parse, modxslt-\/perror, modxslt-\/config) should be copied after compiling them,
generally /usr/bin.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:76}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{\def\fPosture%
{italic}}-\/-\/libdir=LIBDIR\endSeq{}\endNode{} LIBDIR is the directory where mod-\/xslt
library (libmodxslt0) should be installed, generally /usr/lib.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:79}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{\def\fPosture%
{italic}}-\/-\/includedir=INCLUDEDIR\endSeq{}\endNode{} INCLUDEDIR is the directory where libmodxslt
headers should be installed, generally /usr/include.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:82}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{\def\fPosture%
{italic}}-\/-\/mandir=MANDIR\endSeq{}\endNode{} MANDIR is the directory where manual pages
should be installed, generally /usr/man.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\endDisplayGroup{}\endNode{}
...
{listitem-content-mode}}\Seq%
{\def\fPosture%
{italic}}-\/-\/prefix=PREFIX\endSeq{}\endNode{}, if no ``-\/-\/mandir'' is specified, MANDIR
defaults ``PREFIX/man'', while if no ``-\/-\/includedir'' is specified, INCLUDEDIR defaults to ``PREFIX/include''.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:89}}\DisplayGroup%
{\def\StartIndent%
{58\p@}\def\StartIndentFactor%
...
{listitem-content-mode}}\Seq%
{\def\fPosture%
{italic}}-\/-\/exec-\/prefix=EPREFIX\endSeq{}\endNode{}, if no ``-\/-\/bindir'' is specified, BINDIR
defaults to ``EPREFIX/bindir'', while if no ``-\/-\/libdir'' is specified,
LIBDIR defaults to ``PREFIX/libdir''.\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\endDisplayGroup{}\endNode{}\endPar{}\endNode{}\Node%
{\def\Element%
{0:92}}\Par%
{\def\FirstLineStartIndent%
{0\p@}\def\FirstLineStartIndentFactor%
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}Packagers for mod-\/xslt should consider using the DESTDIR environment
variable to have all of mod-\/xslt files installed under a specific directory.\endPar{}\endNode{}\endSeq{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:93}}\DisplayGroup%
{\def\StartIndent%
{48\p@}\def\StartIndentFactor%
...
3.1.6. modxslt Configuration parameters}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:217}}\endNode{}\Node%
{\def\Element%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:232}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:233}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
3.2.1. Configuring Apache 2.x for modxslt}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:342}}\endNode{}\Node%
{\def\Element%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:353}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:354}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{title-sosofo-mode}}mod-\/xslt Configuration parameters\endNode{}\def\HeadingText{%
3.2.2. modxslt Configuration parameters}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:369}}\endNode{}\Node%
{\def\Element%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:394}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:395}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
{italic}}XSLTDebug category, category, category, ...\endSeq{}\endNode{} per directory, per file, per virtual host or in
...
3.2.3. Apache 2.x.x, modxslt and PHP4}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:403}}\endNode{}\Node%
{\def\Element%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:435}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:436}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:438}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:439}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:441}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:442}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:444}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:445}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:447}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:448}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
4.2.2. valueof  modxslt expressions}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:495}}\endNode{}\Node%
{\def\Element%
...
4.4.1. xmlstylesheet and modxsltstylesheet}%
\endHeadPar{}\endSeq{}\Node%
{\def\Element%
{0:584}}\endNode{}\Node%
{\def\Element%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:664}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:665}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:679}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:680}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:682}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}\Node%
{\def\Element%
{0:683}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:716}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}a http URL \Node%
{\def\Element%
{0:717}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{0}}\Character{8226}\endLineField{}\endSeq{}\Node%
{\def\Element%
{0:720}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{}a ftp URL \Node%
{\def\Element%
{0:721}\def\ProcessingMode%
{listitem-content-mode}}\Seq%
{\def\fPosture%
...
{1}}  If you want to help mod-\/xslt development, just drop us a mail in one of
  the mailing lists. We are always happy to get new hands at work. \endPar{}\endNode{}\endSeq{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:852}}\DisplayGroup%
{\def\StartIndent%
{48\p@}\def\StartIndentFactor%
...
{1.25\p@}\def\saMax%
{1.25\p@}\def\saConditional%
{1}}Trademarks are owned by their respective owners.\endPar{}\endNode{}\endSeq{}\endDisplayGroup{}\endNode{}\endSpS{}\endSeq{}\endNode{}\endNode{}\endSeq{}\endFOT{}