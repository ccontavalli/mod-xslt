...
global configuration file, tells mod-\/xslt2 not to output the "Copyright ..." and "this page was created with ..." banner
in parsed documents. To disable the signature, you can also recompile mod-\/xslt with the MXSLT\char95{}DISABLE\char95{}SIGNATURE macro
defined something like (CFLAGS="-\/DMXSLT\char95{}DISABLE\char95{}SIGNATURE").\endSeq{}\endNode{}\endPar{}\endDisplayGroup{}\endNode{}\endDisplayGroup{}\endNode{}
\endPar{}\endNode{}\endSeq{}\endDisplayGroup{}\endNode{}\Node%
{\def\Element%
{0:296}}\DisplayGroup%
{\def\StartIndent%
...
{10\p@}\def\saMax%
{10\p@}\def\saConditional%
{1}}~~LoadModule~mxslt\char95{}module~/usr/lib/apache2/mod\char95{}xslt.so\endPar{}\endNode{}
  Where \Node%
{\def\Element%
{0:368}}\Seq%
