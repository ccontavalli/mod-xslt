...
/* Line 268 of yacc.c  */
#line 118 "../../../lib/parser/modxslt-screen-expr.parser.c"
...
#line 161 "../../../lib/parser/modxslt-screen-expr.y"
    {
	    ...
	    if((yyvsp[(1) - (1)].string) && *(yyvsp[(1) - (1)].string))
...
/* Line 1806 of yacc.c  */
#line 1635 "../../../lib/parser/modxslt-screen-expr.parser.c"
      default: break;
    }
